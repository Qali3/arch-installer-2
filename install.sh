...
pacstrap -K /mnt linux-zen linux-firmware base efibootmgr neovim base-devel git
...
efibootmg --create --disk $DISK --part 1 --label "Arch Linux" --loader /efi/vmlinuz-linux-zen --unicode "root=PARTUUID=$(blkid -s PARTUUID -o value $PART2) initrd=/efi/initramfs-linux-zen.img"
"
